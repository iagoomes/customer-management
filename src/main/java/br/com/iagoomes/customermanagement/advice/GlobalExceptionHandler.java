...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<DefaultError> entityNotFound(CustomerNotFound exception, HttpServletRequest request) {
        log.error("Customer canceled or not exist", exception);
        HttpStatus status = HttpStatus.NOT_FOUND;
        error.setTimeStamp(Instant.now());
        error.setStatus(status.value());
